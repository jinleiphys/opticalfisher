#!/usr/bin/env python3
"""
D_eff scan for 9-parameter KD02 potential using LOG DERIVATIVES.

This version uses d log(sigma) / d log(p) for fair comparison with NN results.
...
def compute_fisher_matrix_log(projectile, A, Z, E_lab, theta_deg, params, eps_rel=0.01):
    """
    Compute Fisher Information Matrix using LOG DERIVATIVES.
...
def main():
    """Main D_eff scan with log derivatives."""

    print("="*70)
    print("D_eff Scan for 9-parameter KD02 (LOG DERIVATIVES)")
    print("="*70)
    ...
    results = {
        'method': 'numerov_log_derivatives',
        ...
        for A, Z, name in nuclei:
            for E in energies:
                ...
                try:
                    ...
                    F, gradients, sigma_0 = compute_fisher_matrix_log(proj, A, Z, E, theta_deg, params)
    ...
    # Save results
    outfile = '/Users/jinlei/Desktop/code/PINN_CFC/PRL_Information_Limit/deff_scan_kd02_9params_log.json'
