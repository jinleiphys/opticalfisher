...
Referee B does not identify a numerical inconsistency in the Fisher analysis. The report's concerns are now addressed explicitly: the Fisher-spectrum meaning of "sloppy" is stated in the Introduction, and the role of external physical constraints is stated in the Discussion. I therefore believe the disagreement no longer concerns the validity of the result, but the breadth of its interpretation. The revised manuscript is scoped to KD02 throughout, and within that scope the result is a compact and broadly useful statement about information limits in optical-potential extraction.
