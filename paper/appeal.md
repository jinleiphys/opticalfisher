...
| 4 | Scope of conclusions (B) | KD02 scoping statements retained throughout the manuscript; the separation between single-energy angular distributions, multi-energy systematics, external physical constraints, and downstream reaction-model error attribution is stated in Point 4 of this appeal |
